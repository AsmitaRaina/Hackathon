    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
      <div className='px-2 flex justify-between items-center w-full h-full'>
        <div className='flex items-center'>
          ...
          <li><Link to="home" smooth={true} duration={500}>Overview</Link></li>
          <li><Link to="about" smooth={true} offset={-200} duration={500}>Why Recruit</Link></li>
          <li><Link to="support" smooth={true} offset={-50} duration={500}>Director's Message</Link></li>
          <li><Link to="platforms" smooth={true} offset={-100} duration={500}>Recruitment Process</Link></li>
          </ul>
        </div>
