...
export default function LoginPage() {
    ...
    const loginType = window.location.href.split('=')[1];
    ...
    const handleSubmit = (event) => {
        ...
        dispatch(login(data.get('email'), data.get('password'), loginType))
    };
          ...
          >
            ...
            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
              ...
              <Grid container>
                ...
                <Grid item>
                    <Link to={`/register?=${loginType}`}>{"Don't have an account? Sign Up"}</Link>
                </Grid>
              </Grid>
              <Copyright sx={{ mt: 5 }} />
            </Box>
