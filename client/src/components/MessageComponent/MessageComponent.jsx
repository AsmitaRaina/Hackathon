...
const MessageComponent = () => {
    ...
    return (
        <div>
            ...
            <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Enim necessitatibus reiciendis vitae quidem, blanditiis vero dicta accusamus corporis. Fugit ducimus magnam, magni aliquid nihil ex. Voluptas necessitatibus repudiandae consequuntur distinctio possimus veritatis quibusdam a in eaque labore, aperiam repellendus cupiditate odit recusandae minus quam! Blanditiis incidunt quo officia nesciunt itaque.
            </p>
