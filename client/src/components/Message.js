...
import { createPost, listPosts } from '../actions/postAction';
...
const Message = () => {
    ...
    const createPostHandler = () => {
        dispatch(createPost(title, message, author));
  ...
  return (
    ...
    <div class="w-[81.5%] border border-red-500 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 fixed bottom-0 ">
        ...
        <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
            ...
            <textarea id="editor" rows="1" class="block w-[80%] text-sm text-gray-800 bg-white border-0 p-4 mb-5 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400 " placeholder="Title of Annoucement" onChange={(e) => setTitle(e.target.value)} required></textarea>
            <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[15%] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 m-5 p-4" onChange={(e)=>setTag(e.target.value)}>
            <option selected value="all">All</option>
            <option value="student">Only Students</option>
            <option value="company">Only Company HR</option>
            </select>
            </div>
            <textarea id="editor" rows="8" class="block w-full text-sm text-gray-800 bg-white border-0 p-4 mb-14 dark:bg-gray-800  dark:text-white dark:placeholder-gray-400 " placeholder="Write an Annoucement ..." onChange={(e) => setMessage(e.target.value)} required></textarea>
        </div>
    </div>
    <button class="px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800 fixed bottom-4 right-6" onClick={createPostHandler}>
        Publish post
    </button>
    </>
  )
