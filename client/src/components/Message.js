...
const Message = () => {
  return (
    <>
    <form >
    <div class="w-full border border-red-500 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 fixed bottom-0 ">
        ...
        <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
            ...
            <textarea id="editor" rows="8" class="block w-full text-sm text-gray-800 bg-white border-0 p-4 mb-14 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400 " placeholder="Write an article..." required></textarea>
        </div>
    </div>
    <button type="submit" class="px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800 fixed bottom-4 left-6">
        Publish post
    </button>
    </form>
